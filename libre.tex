...
\def\latin#1{\mbox{\textit{#1}}\xspace}
\def\al{\latin{et al.}}
\def\cf{\latin{cf.}}
\def\ie{\latin{i.e.}}
\def\eg{\latin{e.g}}
...
\def\OpenMP{\mbox{\textsf{OpenMP}}\xspace}
\def\OpenMPI{\mbox{\textsf{Open~MPI}}\xspace}
\def\gkampi{\mbox{\textsl{gkampi}}\xspace}
\def\jellyfish{\mbox{\textsl{Jellyfish}}\xspace}
\def\libGkArraysMPI{\mbox{\texttt{libGkArrays-MPI}}\xspace}
\def\redoak{\mbox{\textsl{RedOak}}\xspace}
\def\niqki{\mbox{\textsl{Niqki}}\xspace}
\def\onika{\mbox{\textsl{Onika}}\xspace}
\def\lego{\mbox{\textsl{LEGO}}\xspace}
\def\rubiks{\mbox{\textsl{RUBIKS}}\xspace}
\def\pictures{\mbox{\textsl{PICTURES}}\xspace}
\def\ieme{\textsuperscript{ème}\xspace}
